        ...
        <div class="row">
            <section id="main-slider" class="main-slider">
                <div class="flexslider two">
                    <ul class="slides">
                        <li>
                            <img src="{{ asset('img/placehold/slider.png') }}" alt="Slider Image"/>
                    ...
                    <div class="br_grm">
                        <div class="brd_grm_wrap">
                            <div class="brd_grm_img">
                                <img src="{{ asset('img/placehold/bride.png') }}" alt="" />
            ...
            <div id="love_story_tab" class="love_story_tab">
                <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#story2" aria-controls="story2" role="tab" data-toggle="tab"><img src="{{ asset('img/two/kiss1.png') }}" alt="" /><img src=" {{ asset('img/two/kiss2.png') }}" alt="" /></a></li>
                        ...
                        <li role="presentation"><a href="#story5" aria-controls="story5" role="tab" data-toggle="tab"><img src=" {{ asset('img/two/pregnant1.png') }}" alt="" /><img src=" {{ asset('img/two/pregnant2.png') }}" alt="" /></a></li>
                    </ul>
                            ...
                            <div class="item">
                                <div class="brd_grm_wrap">
                                    <div class="family_mem_img">
                                        <img src="{{ asset('img/placehold/family-mem.png')}}" alt="" />
                                    </div>
                                    <div class="heart_frame">
        ...
        <div class="row">
                ...
                <div class="bmaid_nav" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation">
                            <a href="#home"  class="" aria-controls="home" role="tab" data-toggle="tab"><img src="{{ asset('img/placehold/br-grm.png')}}" alt="" /></a>
                        </li>
                        <li role="presentation">
                            <a href="#profile" class="" aria-controls="profile" role="tab"  data-toggle="tab"><img src="{{ asset('img/placehold/br-grm.png')}}" alt="" /></a>
                        </li>
                        <li role="presentation" class="active">
                            <a href="#messages" aria-controls="messages" role="tab" class="" data-toggle="tab"><img src="{{ asset('img/placehold/br-grm.png')}}" alt="" /></a>
                        </li>
                    </ul>
            ...
            <div class="col-lg-6 col-md-6 gmen_sec">
                <div class="gmen_nav" role="tabpanel">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#groom1" class="" aria-controls="home" role="tab" data-toggle="tab"><img src="{{ asset('img/placehold/br-grm.png')}}" alt="" /></a></li>
                        <li role="presentation"><a href="#groom2" class="" aria-controls="profile" role="tab"  data-toggle="tab"><img src="{{ asset('img/placehold/br-grm.png')}}" alt="" /></a></li>
                        <li role="presentation"><a href="#groom3" class="" aria-controls="messages" role="tab"  data-toggle="tab"><img src="{{ asset('img/placehold/br-grm.png')}}" alt="" /></a></li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog_post">
                        ...
                        <div class="blog_img">
                            <a data-gal="prettyPhoto" href="{{ asset('img/placehold/zoom.png')}}" class="hov"><img src="{{ asset('img/placehold/blog.png')}}" alt="" /></a>
                        </div>
                        <p class="blog_text">
                        ...
                        <p class="blog_bottom_line">
                            ...
                            <span><a href="blog-single.html" class="read_more">Read More <img class="arrow" src="{{ asset('img/arrow.png')}}" alt="" /><img class="arrow-hov" src="{{ asset('img/arrow-hov.png')}}" alt="" /></a></span>
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
